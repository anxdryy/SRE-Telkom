...
<head>
    ...
    <title>Competition Programs | SRE Telkom University</title>
    <style>
        body {
...
<body class="min-h-screen bg-white text-gray-800">
    ...
    <main class="max-w-4xl mx-auto mt-40 px-4 md:px-0 mb-12">
        <h1 class="sr-only">Competition Programs</h1>
           ...
           @forelse ($programs as $program)
            ...
            @empty
                <div class="text-center py-16 px-4">
                    ...
                    <p class="text-gray-600 text-lg font-semibold">No competition programs yet.</p>
                    <p class="text-gray-400 mt-1">Check back soon — new competitions are added regularly.</p>
                </div>
            @endforelse
