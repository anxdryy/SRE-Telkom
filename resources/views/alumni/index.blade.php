                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $alumni->created_at->format('Y-m-d H:i') }}</td>
                            <td>{{ $alumni->updated_at->format('Y-m-d H:i') }}</td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('alumni.destroy', $alumni) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this member?');">
                                        @csrf
                                        @method('DELETE')
