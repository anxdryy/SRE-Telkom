...
<nav class="absolute top-8 left-0 w-full flex justify-between items-center md:px-12 text-white px-4 z-50">
    ...
    <button id="hamburgerButton" type="button" aria-label="Toggle menu" aria-expanded="false" aria-controls="mobileMenu" class="md:hidden text-3xl text-white focus:outline-none z-50">
    ...
    <!-- Desktop Navbar -->
    <ul id="navbar" class="hidden md:flex flex-col md:flex-row absolute md:static top-20 right-4 bg-white text-white space-y-4 md:space-y-0 md:space-x-12 text-base uppercase items-start md:items-center rounded-lg p-4 md:p-0 shadow-lg md:shadow-none md:bg-transparent opacity-0 transform -translate-y-10 transition-all duration-1000 delay-500 z-50">
...
<!-- Mobile Menu -->
<div id="mobileMenu" class="bg-opacity-45 fixed inset-0 bg-[#104334] pt-20 px-4 hidden z-50 shadow-lg pointer-events-auto">
    <ul class="space-y-6 text-2xl text-white uppercase">
